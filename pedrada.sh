...
exit;
  ...
  echo -e 'by: keorichssh' >/usr/lib/telegram
  msg -bar
...
wget https://raw.githubusercontent.com/VitorNobre18/Painel-Web/main/raw/painel/install/pweb > /dev/null 2>&1
chmod 777 pweb > /dev/null 2>&1
clear
[[ ! -d /bin/ppweb ]] && mkdir /bin/ppweb
cd /bin/ppweb || exit
rm *.sh ver* > /dev/null 2>&1
wget https://raw.githubusercontent.com/VitorNobre18/Painel-Web/main/raw/painel/install/verifatt.sh > /dev/null 2>&1
wget https://raw.githubusercontent.com/VitorNobre18/Painel-Web/main/raw/painel/install/verpweb > /dev/null 2>&1
wget https://raw.githubusercontent.com/VitorNobre18/Painel-Web/main/raw/painel/install/verweb > /dev/null 2>&1
...
wget https://raw.githubusercontent.com/VitorNobre18/Painel-Web/main/raw/painel/install/gestorssh.zip > /dev/null 2>&1
...
echo ""
chave=$(curl -sSL "https://raw.githubusercontent.com/VitorNobre18/Painel-Web/main/raw/painel/install/chave") &>/dev/null
